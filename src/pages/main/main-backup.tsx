...
import { DashboardIcon, BotBuilderIcon } from '@/components/icons/navigation-icons';
...
const NewHedgerIcon = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <defs>
            <linearGradient id='newHedgerGrad' x1='0%' y1='0%' x2='100%' y2='100%'>
                <stop offset='0%' stopColor='#ff6b6b' />
                <stop offset='50%' stopColor='#4ecdc4' />
                <stop offset='100%' stopColor='#45b7d1' />
            </linearGradient>
            <filter id='newHedgerGlow'>
                <feGaussianBlur stdDeviation='1.5' result='coloredBlur' />
                <feMerge>
                    <feMergeNode in='coloredBlur' />
                    <feMergeNode in='SourceGraphic' />
        ...
        {/* Shield with arrows - representing hedging strategy */}
        <path
            d='M12 2L4 6v6c0 5.5 3.8 10.7 8 12 4.2-1.3 8-6.5 8-12V6l-8-4z'
            stroke='url(#newHedgerGrad)'
            strokeWidth='1.5'
            fill='none'
            filter='url(#newHedgerGlow)'
        />
        {/* Up and down arrows inside shield */}
        <path
            d='M9 10l2-2 2 2M9 14l2 2 2-2'
            stroke='url(#newHedgerGrad)'
            strokeWidth='1.5'
            strokeLinecap='round'
            strokeLinejoin='round'
        ...
        <text x='18' y='8' fontSize='4' fontWeight='bold' fill='#ffffff' textAnchor='middle'>N</text>
        <style>
            {`
                @keyframes newHedgerPulse {
                    0%, 100% { opacity: 1; }
                    50% { opacity: 0.7; }
                }
            `}
                    ...
                    >
                        ...
                        <div
                            label={
                                <>
                                    <NewHedgerIcon />
                                    <Localize i18n_default_text='New Hedger' />
                        ...
                        >
                            <Suspense
                                fallback={<ChunkLoader message={localize('Please wait, loading New Hedger...')} />}
                            >
                                <HedgeStrategyPage />
                            </Suspense>
                        </div>
