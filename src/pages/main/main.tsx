...
const ChartsIcon = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        {/* Chart background */}
        <rect x='3' y='3' width='18' height='16' rx='2' fill='currentColor' opacity='0.1' stroke='currentColor' strokeWidth='1' />
        
        {/* Trending line with gradient */}
        <path d='M6 15l3-4 3 2 4-6 2 1' stroke='url(#chartGrad)' strokeWidth='3' strokeLinecap='round' strokeLinejoin='round' fill='none' />
...
const SignalsIcon = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <path d='M12 15c-3 0-5-2-5-5s2-5 5-5 5 2 5 5-2 5-5 5z' stroke='url(#signalGrad)' strokeWidth='2' fill='none' opacity='0.8'>
            <animate attributeName="opacity" values="0.8;0.3;0.8" dur="2s" repeatCount="indefinite"/>
        </path>
        <path d='M12 13c-2 0-3-1-3-3s1-3 3-3 3 1 3 3-1 3-3 3z' stroke='url(#signalGrad)' strokeWidth='2' fill='none' opacity='0.6'>
            <animate attributeName="opacity" values="0.6;0.2;0.6" dur="2s" begin="0.5s" repeatCount="indefinite"/>
        </path>
        <path d='M12 11c-1 0-1-0.5-1-1s0-1 1-1 1 0.5 1 1 0 1-1 1z' stroke='url(#signalGrad)' strokeWidth='2' fill='none' opacity='0.4'>
        ...
        <circle cx='18' cy='8' r='1' fill='#ffd700'>
            <animateTransform attributeName="transform" type="translate" values="0,0; -6,2; 0,0" dur="3s" begin="1.5s" repeatCount="indefinite"/>
        </circle>
    </svg>
);
...
const FreeBotsIcon = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <text x='20' y='6' textAnchor='middle' fontSize='5' fill='#ffffff' fontWeight='bold'>F</text>
        
        {/* Connection lines */}
        <path d='M10 6h4M6 10v4M10 18h2M17 10v2' stroke='#10b981' strokeWidth='1.5' strokeLinecap='round' opacity='0.6' />
...
const RichMotherIcon = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        {/* Diamond shape */}
        <path d='M12 2L16 8H8L12 2Z' fill='url(#richGrad)' stroke='currentColor' strokeWidth='1.5' strokeLinejoin='round' />
        <path d='M8 8L12 22L16 8H8Z' fill='url(#richGrad)' stroke='currentColor' strokeWidth='1.5' strokeLinejoin='round' opacity='0.8' />
        ...
        <text x='12' y='17' textAnchor='middle' fontSize='6' fill='#e6c200' fontWeight='bold'>$</text>
    </svg>
);
